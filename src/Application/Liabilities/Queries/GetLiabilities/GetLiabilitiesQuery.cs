...
{
    public class GetLiabilitiesQuery : IRequest<LiabilitiesVm>
    {
        public int VehicleId { get; set; }
        public LiabilityType Liability { get; set; }
    }

    public class GetLiabilitiesQueryHandler : IRequestHandler<GetLiabilitiesQuery, LiabilitiesVm>
    {
