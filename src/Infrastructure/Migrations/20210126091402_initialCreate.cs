        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FirstRegistration = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    BeltMileage = table.Column<int>(type: "integer", nullable: false),
                    BrakeLiningsMileage = table.Column<int>(type: "integer", nullable: false),
                    BrakeDisksMileage = table.Column<int>(type: "integer", nullable: false),
                    CoolantMileage = table.Column<int>(type: "integer", nullable: false),
                    FuelConsumption = table.Column<int>(type: "integer", nullable: false),
                    OilMileage = table.Column<int>(type: "integer", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_CivilLiabilities", x => x.Id);
                    table.ForeignKey(
                        name: "FK_CivilLiabilities_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_MOTs_Vehicles_VehicleId",
                        column: x => x.VehicleId,
                        principalTable: "Vehicles",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Mileage = table.Column<int>(type: "integer", nullable: false),
                    Date = table.Column<DateTime>(type: "timestamp without time zone", nullable: false),
                    IsOilChanged = table.Column<bool>(type: "boolean", nullable: false),
                    IsBeltChanged = table.Column<bool>(type: "boolean", nullable: false),
                    IsBatteryChanged = table.Column<bool>(type: "boolean", nullable: false),
                    IsSparkPlugChanged = table.Column<bool>(type: "boolean", nullable: false),
                    IsFuelFilterChanged = table.Column<bool>(type: "boolean", nullable: false),
                    IsBrakeLiningsChanged = table.Column<bool>(type: "boolean", nullable: false),
                    IsBrakeDisksChanged = table.Column<bool>(type: "boolean", nullable: false),
                    IsCoolantChanged = table.Column<bool>(type: "boolean", nullable: false),
                    IsOtherWorkDone = table.Column<bool>(type: "boolean", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_CivilLiabilities_VehicleId",
